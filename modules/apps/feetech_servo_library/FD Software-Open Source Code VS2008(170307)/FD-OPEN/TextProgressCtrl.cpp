...
//WPARAM, LPARAM
LRESULT CTextProgressCtrl::OnSetText(WPARAM wp, LPARAM lp/*UINT, LPCTSTR szText*/)
{
...
LRESULT CTextProgressCtrl::OnGetText(WPARAM wp, LPARAM lp/*UINT cchTextMax, LPTSTR szText*/)
{
	UINT cchTextMax = (UINT)wp;
	LPTSTR szText = (LPTSTR)lp;
	
    if (!_tcsncpy_s(szText, 1, m_strText, cchTextMax))//if (!_tcsncpy(szText, m_strText, cchTextMax))
        return 0;
    else 
